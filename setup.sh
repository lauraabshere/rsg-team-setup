...
echo ""
echo "  ────────────────────────────────────────────────────────"
echo "  Next: Connect your other integrations in Claude Code"
echo "  ────────────────────────────────────────────────────────"
echo ""
echo "  Open Claude Code → Settings → Integrations and connect:"
echo ""
echo "  1. Google Calendar  — so Claude can see your schedule"
echo "  2. Gmail            — so Claude can surface action emails"
echo "  3. HubSpot          — so Claude can show your tasks & tickets"
echo ""
echo "  Once connected, install the RSG Personal Assistant skill:"
echo ""
echo "    claude plugin install personal-assistant@lauraabshere"
echo ""
echo "  Then start a new Claude Code session and type:"
echo "    'set me up' — Claude will auto-detect your IDs"
echo "    'start my day' — run your first daily sweep"
echo ""
